...
VALUES
    (32, 'Funciones Cuadráticas', 'En este tema, exploraremos cómo determinar \n las coordenadas del vértice de una función cuadrática. \nEstas funciones se representan en la forma \n (f(x) = ax^2 + bx + c).\n El vértice es un punto crítico que tiene aplicaciones en física, economía y otras áreas.\n Aprenderemos a aplicar la fórmula del vértice y a interpretar su significado geométrico.'),
